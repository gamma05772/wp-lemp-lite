...
RUN apt-get update && apt-get upgrade && \
 ...
 apt-get install mariadb mariadb-client nginx supervisor php7 php7-fpm php7-mysqli php7-json php7-openssl php7-curl php7-zlib php7-xml php7-phar php7-intl php7-dom php7-xmlreader php7-ctype php7-mbstring php7-gd && \
